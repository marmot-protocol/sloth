...
Future<List<ChatMessage>>  fetchAggregatedMessagesForGroup({required String pubkey , required String groupId }) => RustLib.instance.api.crateApiMessagesFetchAggregatedMessagesForGroup(pubkey: pubkey, groupId: groupId);
...
final int kind;
                ...
                const ChatMessage({required this.id ,required this.pubkey ,required this.content ,required this.createdAt ,required this.tags ,required this.isReply ,this.replyToId ,required this.isDeleted ,required this.contentTokens ,required this.reactions ,required this.mediaAttachments ,required this.kind ,});
        ...
        @override
        int get hashCode => id.hashCode^pubkey.hashCode^content.hashCode^createdAt.hashCode^tags.hashCode^isReply.hashCode^replyToId.hashCode^isDeleted.hashCode^contentTokens.hashCode^reactions.hashCode^mediaAttachments.hashCode^kind.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is ChatMessage &&
                ...
                && id == other.id&& pubkey == other.pubkey&& content == other.content&& createdAt == other.createdAt&& tags == other.tags&& isReply == other.isReply&& replyToId == other.replyToId&& isDeleted == other.isDeleted&& contentTokens == other.contentTokens&& reactions == other.reactions&& mediaAttachments == other.mediaAttachments&& kind == other.kind;
...
final DateTime createdAt;
                ...
                const UserReaction({required this.user ,required this.emoji ,required this.createdAt ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is UserReaction &&
                runtimeType == other.runtimeType
                && user == other.user&& emoji == other.emoji&& createdAt == other.createdAt;
