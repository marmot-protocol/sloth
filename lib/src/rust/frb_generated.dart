...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -365210605;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<Account> crateApiAccountsLoginWithExternalSigner({
    required String pubkey,
  });
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<Account> crateApiAccountsLoginWithExternalSigner({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAccountsLoginWithExternalSignerConstMeta,
        argValues: [pubkey],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAccountsLoginWithExternalSignerConstMeta => const TaskConstMeta(
    debugName: 'login_with_external_signer',
    argNames: ['pubkey'],
  );
