...
class _AuthenticatedAuthNotifier extends AuthNotifier {
  @override
  Future<String?> build() async => 'a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4';
}
...
void main() {
  ...
  group('pushToInvite', () {
    testWidgets('pushes ChatInviteScreen onto stack', (tester) async {
      ...
      Routes.pushToInvite(getContext(tester), 'a1b2c3d4e5f6a1b2');
      await tester.pumpAndSettle();
  ...
  group('goToChat', () {
    testWidgets('navigates to ChatScreen', (tester) async {
      ...
      Routes.goToChat(getContext(tester), 'a1b2c3d4e5f6a1b2');
      await tester.pumpAndSettle();
