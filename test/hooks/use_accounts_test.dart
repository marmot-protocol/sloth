  ...
  group('useAccounts', () {
    testWidgets('starts with waiting state', (tester) async {
      ...
      await mountTestWidget(
        tester,
        currentPubkey: 'a1111111111111111111111111111111',
        onBuild: (accounts, state, switchTo) {
    ...
    testWidgets('returns accounts when loaded', (tester) async {
      ...
      expect(capturedAccounts.data![0].pubkey, 'a1111111111111111111111111111111');
      expect(capturedAccounts.data![1].pubkey, 'b2222222222222222222222222222222');
    });
    ...
    testWidgets('sets error state when switchProfile throws', (tester) async {
      ...
      await capturedSwitchTo('b2222222222222222222222222222222');
      await tester.pumpAndSettle();
    ...
    testWidgets('clears error when retrying switchTo', (tester) async {
      ...
      mockAuthNotifier.switchProfileCompleter = Completer<void>();
      unawaited(capturedSwitchTo('b2222222222222222222222222222222'));
      await tester.pump();
